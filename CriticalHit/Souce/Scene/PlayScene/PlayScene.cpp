...
#include "..\..\UI\Reticule.h"
#include "SkyDoom.h"
#include "Ground.h"
#include "..\..\UI\HPGauge.h"
#include "..\..\UI\SpecialUI.h"
#include "..\..\UI\ChargeUI.h"
...
void PlayScene::StateDemo(float elapedTime)
{
	...
	DirectX::SimpleMath::Vector3 camera = DirectX::SimpleMath::Vector3(5.0f * static_cast<float>(sin(0)), 0.0f, 5.0f * static_cast<float>(cos(0)));

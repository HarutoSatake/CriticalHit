...
public:
	...
	void Draw(DirectX::SimpleMath::Matrix world, DirectX::SimpleMath::Matrix view, DirectX::SimpleMath::Matrix proj,int type);
...
private:
	...
	// ピクセルシェーダ(フェードイン)
	Microsoft::WRL::ComPtr<ID3D11PixelShader> m_fadeInPS;
	// ピクセルシェーダ(フェードアウト)
	Microsoft::WRL::ComPtr<ID3D11PixelShader> m_fadeOutPS;
	// ジオメトリシェーダ
